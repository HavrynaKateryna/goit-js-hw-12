import{a as b,S as v,i as n}from"./assets/vendor-BDvqwvWe.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))s(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const d of t.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&s(d)}).observe(document,{childList:!0,subtree:!0});function a(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function s(e){if(e.ep)return;e.ep=!0;const t=a(e);fetch(e.href,t)}})();const C=b.create({baseURL:"https://pixabay.com/api/",timeout:1e3});async function m(r,o){try{const a=await C.get("/",{params:{key:"53407637-c830e4422b7f45a16c416a939",q:r,image_type:"photo",orientation:"horizontal",safesearch:!0,page:o,per_page:15}}),{hits:s,totalHits:e}=a.data;return{hits:s,totalHits:e}}catch(a){console.error(a)}}const L=new v(".gallery-link",{captionsData:"alt",captionPosition:"bottom",captionDelay:500}),l={gallery:document.querySelector(".js-gallery"),loader:document.querySelector(".loader"),loadMoreBtn:document.querySelector(".load-btn")};function w({webformatURL:r,largeImageURL:o,tags:a,likes:s,views:e,comments:t,downloads:d}){return`<li class="gallery-item">
